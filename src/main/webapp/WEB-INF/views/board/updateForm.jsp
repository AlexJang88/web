...
<script language="JavaScript" src="/mvc/resources/js/script.js"></script>
</head>
<body bgcolor="${bodyback_c}">  
<center><b>글수정</b>
<br>
<form method="post" name="writeform" action="/free/updatePro?pageNum=${pageNum}" onsubmit="return writeSave()">
